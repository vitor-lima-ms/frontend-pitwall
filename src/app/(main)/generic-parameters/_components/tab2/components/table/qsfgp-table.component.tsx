...
import GpQsfgpsExpand from "./gp-qsfgps-expand.component";
...
const QsfgpsTable: React.FC = () => {
  ...
  return (
    <Table<(typeof dataSource)[0]>
      ...
      expandable={{
        expandedRowRender: ({ gpName, gpQsfgps, key }) => (
          <GpQsfgpsExpand data={gpQsfgps} gpId={key} gpName={gpName} />
        ),
      }}
      pagination={{
