...
import SpSamplesExpand from "./sp-samples-expand.component";
/* Context imports */
...
const SmpsTable: React.FC = () => {
  ...
  return (
    <Table<(typeof dataSource)[0]>
      ...
      expandable={{
        expandedRowRender: ({ key, spName, spSamples }) => (
          <SpSamplesExpand data={spSamples} spId={key} spName={spName} />
        ),
      }}
      pagination={{
